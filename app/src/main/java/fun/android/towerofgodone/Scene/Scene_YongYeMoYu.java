...
import fun.android.towerofgodone.Data.yongyemoyu.AnYingMoYi;
import fun.android.towerofgodone.Data.yongyemoyu.AnYingSanTouShou;
import fun.android.towerofgodone.Data.yongyemoyu.ManYanGuMo;
import fun.android.towerofgodone.Data.yongyemoyu.MoMangBaHaMu;
import fun.android.towerofgodone.Data.yongyemoyu.ShiShenMoNiu;
import fun.android.towerofgodone.Data.yongyemoyu.YanSheMo;
import fun.android.towerofgodone.Data.yongyemoyu.YanYiMoZun;
import fun.android.towerofgodone.Data.yongyemoyu.YuanShiSheHuang;
import fun.android.towerofgodone.Data.yongyemoyu.ZiYiMoShi;
...
public class Scene_YongYeMoYu extends Scene_Base{
    public Scene_YongYeMoYu(Context context) {
        ...
        enemy_1.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/yuanshishehuang.png"));
        ImageView enemy_2 = view.findViewById(R.id.enemy_2);
        enemy_2.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/momangbahamu.png"));
        ImageView enemy_3 = view.findViewById(R.id.enemy_3);
        enemy_3.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/anyingsantoushou.png"));
        ImageView enemy_4 = view.findViewById(R.id.enemy_4);
        enemy_4.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/shishenmoniu.png"));
        ImageView enemy_5 = view.findViewById(R.id.enemy_5);
        enemy_5.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/ziyimoshi.png"));
        ImageView enemy_6 = view.findViewById(R.id.enemy_6);
        enemy_6.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/yanshemo.png"));
        ImageView enemy_7 = view.findViewById(R.id.enemy_7);
        enemy_7.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/manyangumo.png"));
        ImageView enemy_8 = view.findViewById(R.id.enemy_8);
        enemy_8.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/anyingmoyi.png"));
        ImageView enemy_9 = view.findViewById(R.id.enemy_9);
        enemy_9.setImageBitmap(fun.loadBitmapFromAssets(context, "yongyemoyu/yanyimozun.png"));
    ...
    public void enable_scene(Context context) {
        ...
        Bitmap back = fun.loadBitmapFromAssets(context, "yongyemoyu/back_" + fun.Random(7) + ".png");
