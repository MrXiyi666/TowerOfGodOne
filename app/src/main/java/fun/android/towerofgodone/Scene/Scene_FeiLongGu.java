...
import fun.android.towerofgodone.Data.feilonggu.AnYan;
import fun.android.towerofgodone.Data.feilonggu.BingJingLong;
import fun.android.towerofgodone.Data.feilonggu.CuiYingLingLong;
import fun.android.towerofgodone.Data.feilonggu.FeiLongWang;
import fun.android.towerofgodone.Data.feilonggu.HuangJinSanTouLong;
import fun.android.towerofgodone.Data.feilonggu.JinLingShengLong;
import fun.android.towerofgodone.Data.feilonggu.LongShi;
import fun.android.towerofgodone.Data.feilonggu.XianNvLong;
import fun.android.towerofgodone.Data.feilonggu.YanYiMoLong;
import fun.android.towerofgodone.Data.feilonggu.ZuanShiLong;
...
public class Scene_FeiLongGu extends Scene_Base{
    public Scene_FeiLongGu(Context context) {
        ...
        enemy_1.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/longshi.png"));
        ImageView enemy_2 = view.findViewById(R.id.enemy_2);
        enemy_2.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/yanyimolong.png"));
        ImageView enemy_3 = view.findViewById(R.id.enemy_3);
        enemy_3.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/jinlingshenglong.png"));
        ImageView enemy_4 = view.findViewById(R.id.enemy_4);
        enemy_4.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/cuiyinglinglong.png"));
        ImageView enemy_5 = view.findViewById(R.id.enemy_5);
        enemy_5.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/bingjinglong.png"));
        ImageView enemy_6 = view.findViewById(R.id.enemy_6);
        enemy_6.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/huangjinsantoulong.png"));
        ImageView enemy_7 = view.findViewById(R.id.enemy_7);
        enemy_7.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/xiannvlong.png"));
        ImageView enemy_8 = view.findViewById(R.id.enemy_8);
        enemy_8.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/zuanshilong.png"));
        ImageView enemy_9 = view.findViewById(R.id.enemy_9);
        enemy_9.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/anyan.png"));
        ImageView enemy_10 = view.findViewById(R.id.enemy_10);
        enemy_10.setImageBitmap(fun.loadBitmapFromAssets(context, "feilonggu/feilongwang.png"));
    ...
    public void enable_scene(Context context) {
        ...
        Bitmap back = fun.loadBitmapFromAssets(context, "feilonggu/back_" + fun.Random(7) + ".png");
